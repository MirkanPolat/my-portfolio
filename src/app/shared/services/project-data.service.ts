  ...
  private projects: Project[] = [ 
    {
      ...
      featured: true,
      badgeImage: 'assets/img/project-imgs/featured.svg',
      image: 'assets/img/project-imgs/Laptop.svg',
      ...
      duration: '3 weeks',
      technologies: [
        { icon: 'assets/img/Skill-Icons/CSS.svg', name: 'CSS' },
        { icon: 'assets/img/Skill-Icons/HTML.svg', name: 'HTML' },
        { icon: 'assets/img/Skill-Icons/Firebase.svg', name: 'Firebase' },
        { icon: 'assets/img/Skill-Icons/Angular.svg', name: 'Angular' },
        { icon: 'assets/img/Skill-Icons/Ts.svg', name: 'TypeScript' }
      ]
    },
    {
      id: 'el-pollo-loco',
      ...
      image: 'assets/img/project-imgs/El-Pollo-Loco.svg',
      ...
      duration: '3 weeks',
      technologies: [
        { icon: 'assets/img/Skill-Icons/Js.svg', name: 'JavaScript' },
        { icon: 'assets/img/Skill-Icons/HTML.svg', name: 'HTML' },
        { icon: 'assets/img/Skill-Icons/CSS.svg', name: 'CSS' }
      ]
    },
